...
public class DuréeTest {
    ...
    public void testAjouterUneSeconde() {
        ...
        assertTrue(new Durée(1, 2, 4).égal(d123.ajouterUneSeconde()));
        Durée d1259 = new Durée(1, 2, 59);
        assertTrue(new Durée(1, 3, 0).égal(d1259.ajouterUneSeconde()));
        Durée d5959 = new Durée(1, 59, 59);
        assertTrue(new Durée(2, 0, 0).égal(d5959.ajouterUneSeconde()));
    }
